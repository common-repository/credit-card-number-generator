...
class Credit_Card_Number_Generator_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		//sub title
		echo apply_filters( 'ccng_generator_sub_title', __( 'Please select card type to get credit card number.', 'credit-card-number-generator' ) );
		...
		do_action( 'ccng_before_generator_content', $instance );
		?>
		...
		//Allow third party to add their content
		do_action( 'ccng_after_generator_content', $instance );
